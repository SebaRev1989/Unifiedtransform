                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white bg-dark rounded-3">
                                <h3>Bienvenidos a Gestion Escolar!</h3>
                                <p><i class="bi bi-emoji-heart-eyes"></i> Gracias por su apoyo.</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                <h3>Mejora la gestion de tu Escuela</h3>
                                <p class="text-end">con <i class="bi bi-lightning"></i> <a href="https://github.com/changeweb/Unifiedtransform" target="_blank" style="text-decoration: none;">Gestion Escolar</a> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6">
                            <div class="card mb-3">
                                <div class="card-header bg-transparent d-flex justify-content-between"><span><i class="bi bi-megaphone me-2"></i> Novedades</span> {{ $notices->links() }}</div>
                                <div class="card-body p-0 text-dark">
                                    <div>
                                        ...
                                        <div class="accordion accordion-flush" id="noticeAccordion">
                                            ...
                                            @endisset
                                            @if(count($notices) < 1)
                                                <div class="p-3">Sin novedades</div>
                                            @endif
                                        </div>
                                    </div>
                                </div>
